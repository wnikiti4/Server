...
def initialize_build_struct():
    ...
    build = [[[Room(paramSystem.a,
                    paramSystem.y)] * paramSystem.countRoom] * paramSystem.countRoom] * paramSystem.countRoom
...
def fun2(param):
    ...
    struct_build = initialize_build_struct()
    function_ambient_temp = initialize_ambient_temp()
    error, control, result, ambient_temp = calculation_house_function(function_ambient_temp, struct_build, 0,
                                                                      paramSystem.days_calculate_fun2)
    return max(error)
